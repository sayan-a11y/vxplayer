...
const PLACEMENT_KILLS: { key: keyof SettingsDTO; label: string; desc: string }[] = [
  ...
  { key: 'videoOverlayEnabled', label: 'Video Overlay', desc: 'In-player video overlay during playback' },
  { key: 'imageOverlayEnabled', label: 'Image Overlay', desc: 'In-player image overlay during playback' },
  ...
  { key: 'homeFeedEnabled', label: 'Home Feed', desc: 'In-feed ads between Home sections' },
  { key: 'betweenCardsEnabled', label: 'Between Cards', desc: 'Ad cards inside video card grids' },
  { key: 'upNextEnabled', label: 'Up Next', desc: 'Ads inside the player Up Next drawer' },
  { key: 'playerBottomEnabled', label: 'Player Bottom', desc: 'Ads beneath the player controls area' },
]
...
const DEFAULT_SETTINGS: SettingsDTO = {
  ...
  betweenCardsEnabled: true,
  upNextEnabled: true,
  playerBottomEnabled: true,
  adsPerSession: 6,
  maxMidRolls: 2,
  overlayPerHour: 3,
