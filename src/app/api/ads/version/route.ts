  ...
  try {
    ...
    return NextResponse.json({
      ...
      settings: {
        ...
        videoOverlayEnabled: (settings as any).videoOverlayEnabled ?? settings.overlayEnabled ?? true,
        imageOverlayEnabled: (settings as any).imageOverlayEnabled ?? settings.overlayEnabled ?? true,
        overlayEnabled: settings.overlayEnabled,
        bannerEnabled: settings.bannerEnabled,
        footerEnabled: (settings as any).footerEnabled ?? true,
        homeFeedEnabled: (settings as any).homeFeedEnabled ?? true,
        betweenCardsEnabled: (settings as any).betweenCardsEnabled ?? true,
        upNextEnabled: (settings as any).upNextEnabled ?? true,
        playerBottomEnabled: (settings as any).playerBottomEnabled ?? true,
